...
export default function DashboardCard({ card }: { card: TDashboardCard }) {
  return (
    <div className="w-full rounded md:rounded-lg shadow-md p-3 md:py-4 md:px-5 border border-borderLight ">
      <div className="flex items-center justify-between text-textDarkGrey text-sm md:text-base font-medium">
        <p>{card?.title}</p>
        {card?.icon}
      </div>
      <div className="pt-3 md:pt-6">
        <h2 className="text-xl md:text-3xl font-medium flex items-center gap-0.5">
