...
const AppTable = ({
  ...
  return (
    <div className="w-full  border border-borderLight ">
      {/* Table header here  */}
      {!button && !headerText && !inputPlaceholder ? (
        <></>
      ) : (
        <div className="bg-borderLight w-full flex gap-2 lg:gap-0 flex-col md:flex-row justify-between p-2 lg:p-3 rounded-t-2xl">
          <div
