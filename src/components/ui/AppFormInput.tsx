        ...
        <>
          <div className="relative float-label-input w-full min-w-[200px]">
            <input
              ...
              placeholder={" "}
              // className="peer h-full w-full rounded border border-borderColor border-t-transparent bg-transparent px-3 2xl:px-4 py-2.5 font-sans text-base 2xl:text-lg font-normal text-textBlack outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-borderColor placeholder-shown:border-t-borderColor focus:border-2 focus:border-primary focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50 placeholder:opacity-0 focus:placeholder:opacity-100 caret-primary"
