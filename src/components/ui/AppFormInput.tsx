                ...
                <>
                    <div className="relative float-label-input w-full min-w-[200px]">
                        <input
                            ...
                            className="block w-full bg-white focus:outline-none focus:shadow-outline border 2xl:border-[1.5px] border-[#D0D2D5] rounded 2xl:rounded py-2 md:py-2.5 2xl:py-2.5 px-2 2xl:px-3 appearance-none leading-normal focus:border-primary"
                        />
                        <label
