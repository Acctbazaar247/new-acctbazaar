...
const AppInput = ({ type, placeholder, icon, className, onChange, error, value }: TAppInputProps) => {
    ...
    return (
        <>
            <div className={`w-full h-fit flex items-center gap-1 md:gap-2 text-sm md:text-base border  rounded md:rounded-md  2xl:rounded-lg px-2 py-1.5 md:px-4 md:py-1.5 lg:py-2 2xl:px-4 2xl:py-2.5 ${error ? "border-red" : "border-borderColor"} ${className}`}>
