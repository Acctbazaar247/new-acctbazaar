...
export default function ReadyToStart({ readySection }: TReadySection) {
  ...
  return (
    <div className="container py-16 px-4">
      <div
        className="relative bgGradient rounded-xl lg:rounded-3xl"
        data-aos="fade-up"
        data-aos-duration="1500"
      >
        <img
          className="rounded-3xl w-full h-[420px] lg:h-full"
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col text-center items-center justify-center rounded-3xl px-4">
          <h2 className="headline text-left lg:text-center pb-4">
            {readySection?.title}
          </h2>
