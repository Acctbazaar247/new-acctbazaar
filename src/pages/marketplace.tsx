    ...
    <HomeLayout>
      <PrivateLayout>
        <div className="container pb-5 md:py-10 2xl:py-12">
          ...
          {/* this is main div  */}
          <div className=" flex gap-4 min-h-[74dvh] max-h-[77dvh] 2xl:max-h-[74dvh] w-full 2xl:gap-6 pt-2 md:pt-4 lg:pt-5 2xl:pt-6">
            ...
            <div className="w-full mt-[120px] md:mt-0">
              <div className="w-full bg-white max-h-[72dvh] md:max-h-[74dvh] overflow-auto p-2 md:p-4 2xl:p-6">
