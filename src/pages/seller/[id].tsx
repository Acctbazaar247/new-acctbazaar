...
const SellerDetailsPage = () => {
    ...
    const queryData = useGetAccountsQuery("");
        ...
        <HomeLayout>
            <PrivateLayout>
                <div className="layout">
                    ...
                    <h2 className="space-x-2 "> <span className=" font-semibold">MarketPlace</span> <span>/</span> <span className="text-xl  font-semibold">Merchant</span></h2>
                    ...
                    <div className="pt-2 md:pt-4 lg:pt-5 2xl:pt-6">
                        <div className="flex flex-col md:flex-row gap-4 2xl:gap-6 min-h-[75dvh]">
                            ...
                            <div className="hidden md:block md:w-[68%] min-h-full bg-white  rounded-lg  p-2 md:p-4">
                                ...
                                {activeTab === "Ads" && <div className='max-h-[67.8dvh] overflow-auto'>
                                    <AppRenderReduxData
                                        queryData={queryData}
                                ...
                                {activeTab === "Reviews" && <div className='max-h-[67.8dvh] overflow-auto'>
                                    <div className='flex items-center gap-4 text-sm py-4'>
                                        <button onClick={() => setActiveReviewTab("All")} className={`${activeReviewTab === "All" && "border"} px-2 py-1 rounded hover:bg-gray-100`}>All(150)</button>
                                        <button onClick={() => setActiveReviewTab("Positive")} className={`${activeReviewTab === "Positive" && "border"} px-2 py-1 rounded hover:bg-gray-100`}>Positive(50)</button>
                                        <button onClick={() => setActiveReviewTab("Negative")} className={`${activeReviewTab === "Negative" && "border"} px-2 py-1 rounded hover:bg-gray-100`}>Negative(50)</button>
                                    </div>
                                    <AppRenderReduxData
                                        queryData={queryData}
                                        loadingComponent={<AccountLoading />}
